...
function Explore(props){  
    ...
    const [resultsCards, setResultsCards] = useState([]); //Place initial state value on pg refresh on right side
    ...
    */
    ...
    const genreButtonsRender = () => { 
        ...
        genreButtons = [...genresButtonsArray];
    }
    ...
    const renderResultsCards = (data) => {  //Every item to insert into slide
        ...
        resultsCards.splice(0, resultsCards.length);
        resultsCards = [...resultsArray];
